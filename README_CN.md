...
- 🌟 [**社区贡献 Skills**](#社区贡献-skills) - 框架文档、Web性能、国际化、部署与社交媒体
...
用于管理社交媒体账号、内容管道和品牌策略的 skills。

#### [X/Twitter 社交媒体经理](./x-social-manager)

个人 X/Twitter 社交媒体管理 skill，具备深度选题研究、电影级推文撰写以及结构化排期指导。

**使用场景：**
- 在 X/Twitter 上管理个人或项目品牌
- 撰写富有吸引力的、面向开发者的帖子和回复
- 强制执行标准账号（280字符）长度限制保护
- 规划 60/40 的日常互动与产品展示帖子比例
- 在发布前通过严格的人工审批门槛审查和编辑帖子

**功能特性：**
- **选题研究管道**：起草前的深度搜索与内容分析
- **电影级推文撰写器**：结构化排版、叙事钩子和表情符号间距优化
- **真实回复引擎**：符合真实开发者互动规则的上下文丰富回复
- **自我改进的记忆闭环**：动态存储，反映最新的战略调整和学习所得
- **安全发布网关**：本地自动发布，受到显式“yes”确认指令的严格限制

**技术栈：** ClawHub CLI, Paks CLI, Node.js, Git, Bash

[查看 Skill →](./x-social-manager)
